...
export const SettingsRolePermissionsObjectLevelObjectForm = ({
  ...
  // ponytail: row-level predicate validation was an Enterprise feature; without
  // configurable predicates the finish step is never blocked by them.
  const isFinishDisabled = false;
